  ...
  return (
    <div>
      ...
      {get_connexion_type() == 0 && (
        <div>
          <button onClick={() => setConnexionType(1)}>{textcontainer_var.export_text(get_language_int(), 2, 1)}</button>
          <button onClick={() => setConnexionType(2)}>{textcontainer_var.export_text(get_language_int(), 2, 0)}</button>
        </div>
      )}
      ...
      {get_connexion_type() == 1 && (
        <div>
          ...
          <button onClick={() => resetpassword()}>{textcontainer_var.export_text(get_language_int(), 2, 2)}</button>
        </div>
      )}
